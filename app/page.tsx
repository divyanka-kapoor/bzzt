...
export default function Home() {
  return (
    <main id="main-content" className="overflow-x-hidden" style={{ background: '#f7ede2', color: '#1a1214' }}>
      ...
      <nav aria-label="Main navigation"
        ...
        style={{ background: 'rgba(247,237,226,0.92)', backdropFilter: 'blur(12px)', borderBottom: '1px solid rgba(245,202,195,0.4)' }}>
        <span className="text-base font-bold tracking-tight" style={{ color: '#1a1214' }}>Bzzt</span>
        <div className="flex items-center gap-8">
          <Link href="/lookup" className="text-sm font-medium focus:outline-none focus:underline" style={{ color: '#5c4f55' }}>Check your risk</Link>
          <Link href="/dashboard" className="text-sm font-medium focus:outline-none focus:underline" style={{ color: '#5c4f55' }}>See the map</Link>
        </div>
      </nav>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(150deg, #f5cac3 0%, #f7ede2 55%)' }}
      >
        <div className="max-w-screen-xl mx-auto w-full">
          <ScrollReveal>
            <p className="text-xs font-bold uppercase tracking-[0.25em] mb-10" style={{ color: '#84a59d' }}>
          ...
          <ScrollReveal delay={200}>
            <p className="text-xl md:text-2xl leading-relaxed max-w-xl mb-4" style={{ color: '#5c4f55', fontWeight: 300 }}>
              Most disease alerts come after the outbreak has already started.
            </p>
            <p className="text-xl md:text-2xl leading-relaxed max-w-xl mb-16 font-semibold" style={{ color: '#1a1214' }}>
      ...
      <section aria-label="Key statistics" className="min-h-[85vh] flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32"
        ...
        <div className="max-w-screen-xl mx-auto w-full">
          <ScrollReveal>
            <p className="text-xs font-bold uppercase tracking-[0.25em] mb-20" style={{ color: '#84a59d' }}>The scale</p>
          </ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8">
            {[
              ...
              <ScrollReveal key={n} delay={delay}>
                <div className="text-[clamp(2.5rem,5vw,4.5rem)] font-bold tracking-tight mb-4" style={{ color: '#c05060' }}>{n}</div>
                <div className="text-lg font-semibold mb-3" style={{ color: '#1a1214' }}>{sub}</div>
                <div className="text-sm leading-relaxed" style={{ color: '#5c4f55' }}>{note}</div>
              </ScrollReveal>
            ))}
          </div>
          ...
          <ScrollReveal delay={200} className="mt-24">
            <div className="rounded-3xl p-10 md:p-12 max-w-3xl" style={{ background: '#f5cac3' }}>
              <p className="text-xs font-bold uppercase tracking-[0.25em] mb-5" style={{ color: '#c05060' }}>
                Signal validated — Delhi, May 2026
              </p>
              <p className="text-lg leading-relaxed mb-4" style={{ color: '#3d3035' }}>
      ...
      <section aria-labelledby="problem-heading" className="min-h-[90vh] flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32"
        ...
        <div className="max-w-screen-xl mx-auto w-full">
          <ScrollReveal>
            <p className="text-xs font-bold uppercase tracking-[0.25em] mb-12" style={{ color: '#84a59d' }}>The problem</p>
            <h2 id="problem-heading" className="text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-tight mb-20 max-w-3xl" style={{ color: '#1a1214' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {[
              ...
              <ScrollReveal key={n} delay={i * 80}>
                <div className="rounded-2xl p-8 h-full border" style={{ background: '#f7ede2', borderColor: 'rgba(245,202,195,0.6)' }}>
                  <div className="text-xs font-mono mb-4" style={{ color: '#84a59d' }}>{n}</div>
                  <h3 className="text-base font-semibold mb-3" style={{ color: '#1a1214' }}>{title}</h3>
      ...
      <section aria-label="Mission statement" className="min-h-[50vh] flex items-center px-8 md:px-16 lg:px-24 py-32"
        ...
        <div className="max-w-screen-xl mx-auto w-full">
          <ScrollReveal>
            <blockquote className="text-[clamp(1.75rem,3.5vw,3rem)] font-bold leading-snug max-w-4xl" style={{ color: '#1a1214' }}>
      ...
      <section aria-labelledby="how-heading" className="min-h-[90vh] flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32"
        ...
        <div className="max-w-screen-xl mx-auto w-full">
          <ScrollReveal>
            <p className="text-xs font-bold uppercase tracking-[0.25em] mb-12" style={{ color: '#84a59d' }}>How it works</p>
            <h2 id="how-heading" className="text-[clamp(2rem,4vw,3rem)] font-bold mb-20 max-w-2xl" style={{ color: '#1a1214' }}>
              Three steps. Fully automated. Running every night.
            </h2>
          </ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {[
              { accent: '#c05060', bg: '#f5cac3', n: '01', title: 'Read the weather', body: 'Every night, Bzzt fetches 90 days of temperature, rainfall, and humidity for every monitored district. The key signal is what the weather was doing 10 weeks ago — when the mosquitoes started breeding.' },
              { accent: '#9a6b2a', bg: '#f6e5b0', n: '02', title: 'Score the risk', body: 'A model trained on 1.1 million real outbreak records from 102 countries converts weather signals into an outbreak probability. Rising symptom search trends and CHW field reports boost the score.' },
              { accent: '#4a7a72', bg: '#d4e8e4', n: '03', title: 'Send the warning', body: 'High-risk districts get an early warning by SMS, WhatsApp, or USSD for feature phones with no data plan. Bilingual — English plus the local language of that district.' },
              ...
              <ScrollReveal key={n} delay={i * 120} className="rounded-2xl p-10" style={{ background: bg }}>
                ...
                <h3 className="text-lg font-bold mb-4" style={{ color: '#1a1214' }}>{title}</h3>
                <p className="text-sm leading-relaxed" style={{ color: '#3d3035' }}>{body}</p>
              </ScrollReveal>
            ))}
          </div>
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <ScrollReveal key={who} delay={i * 80}>
                <div className="rounded-xl p-6 flex gap-4 items-start border" style={{ background: 'rgba(255,255,255,0.5)', borderColor: 'rgba(245,202,195,0.5)' }}>
                  <span className="text-2xl shrink-0" role="img" aria-label={who}>{icon}</span>
                  <div>
                    <div className="text-sm font-semibold mb-1" style={{ color: '#1a1214' }}>{who}</div>
                    <div className="text-xs leading-relaxed" style={{ color: '#5c4f55' }}>{note}</div>
                  </div>
                </div>
              </ScrollReveal>
            ))}
      ...
      <section aria-labelledby="proof-heading" className="min-h-[90vh] flex flex-col justify-center px-8 md:px-16 lg:px-24 py-32"
        ...
        <div className="max-w-screen-xl mx-auto w-full">
          <ScrollReveal>
            <p className="text-xs font-bold uppercase tracking-[0.25em] mb-12" style={{ color: '#84a59d' }}>The science</p>
            <h2 id="proof-heading" className="text-[clamp(2rem,4vw,3rem)] font-bold mb-20 max-w-2xl" style={{ color: '#1a1214' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            {/* Lag chart */}
            <ScrollReveal delay={100}>
              <div className="rounded-2xl p-10" style={{ background: '#f7ede2' }}>
                ...
                <div className="space-y-4"
                  ...
                  {[
                    ...
                    <div key={lag} className="flex items-center gap-5">
                      <div className="text-xs w-14 text-right shrink-0" style={{ color: '#5c4f55' }}>{lag}</div>
                      <div className="flex-1 rounded-full h-3 overflow-hidden" style={{ background: '#f5cac3' }}>
                        <div className="h-full rounded-full" style={{ width: `${r * 195}%`, background: peak ? '#c05060' : '#84a59d', opacity: peak ? 1 : 0.6 }} />
                      </div>
                      <div className="text-xs w-32 shrink-0 font-semibold" style={{ color: peak ? '#c05060' : '#5c4f55' }}>
                        r = {r}{peak ? ' ← peak' : ''}
                      </div>
                    </div>
                  ))}
                </div>
                <p className="text-xs mt-8 leading-relaxed" style={{ color: '#5c4f55' }}>
            ...
            <div className="space-y-6">
              {[
                ...
                <ScrollReveal key={stat} delay={delay}>
                  <div className="rounded-2xl p-8 border" style={{ background: '#f7ede2', borderColor: 'rgba(245,202,195,0.6)' }}>
                    <div className="text-3xl font-bold mb-2" style={{ color: '#c05060' }}>{stat}</div>
                    <div className="text-sm font-semibold mb-2" style={{ color: '#1a1214' }}>{label}</div>
      ...
      <section id="enroll" aria-labelledby="enroll-heading"
        ...
        style={{ background: '#f5cac3' }}>
        <div className="max-w-screen-xl mx-auto w-full">
          <div className="max-w-2xl">
            <ScrollReveal>
              <p className="text-xs font-bold uppercase tracking-[0.25em] mb-10" style={{ color: '#c05060' }}>Get protected</p>
              <h2 id="enroll-heading" className="text-[clamp(2rem,4.5vw,3.5rem)] font-bold leading-tight mb-8" style={{ color: '#1a1214' }}>
                Get an early warning<br />for your district.
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={100}>
              <p className="text-lg leading-relaxed mb-12" style={{ color: '#3d3035' }}>
            ...
            <ScrollReveal delay={300}>
              <p className="text-sm mt-8" style={{ color: '#5c4f55' }}>
      ...
      {/* ── FOOTER ──────────────────────────────────────────────────────── */}
      <footer className="px-8 md:px-16 lg:px-24 py-12 border-t" style={{ background: '#f7ede2', borderColor: '#f5cac3' }}>
        <div className="max-w-screen-xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6 text-xs" style={{ color: '#5c4f55' }}>
          <div className="space-y-1">
            <div className="font-bold" style={{ color: '#1a1214' }}>Bzzt</div>
            <div>Autonomous mosquito-borne disease early warning · © 2026</div>
          </div>
          <div className="flex items-center gap-6 flex-wrap">
            <span>Data: Open-Meteo · OpenDengue · WHO · GADM</span>
            <Link href="/dashboard" className="font-medium hover:underline focus:outline-none focus:underline" style={{ color: '#3d3035' }}>Intelligence map</Link>
            <Link href="/lookup" className="font-medium hover:underline focus:outline-none focus:underline" style={{ color: '#3d3035' }}>Risk lookup</Link>
          </div>
        </div>
      </footer>
    </main>
